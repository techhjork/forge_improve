'use strict';
export default window.ThreeBSP = (function () {
    ...
    ThreeBSP.prototype.toGeometry = function () {  //  matrix = new THREE.Matrix4().getInverse(this.matrix),
        var i, j,
    ...
    ThreeBSP.prototype.toBufferGeometry = function () {
        var i, j,
            matrix = new THREE.Matrix4().copy(this.matrix).invert(), //new THREE.Matrix4().getInverse(this.matrix),
            geometry = new THREE.BufferGeometry(),
